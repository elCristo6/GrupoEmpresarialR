...
class PDFService {
  ...
  // Helper function to shorten the empresa name
  String shortenEmpresaName(String empresa) {
    if (empresa.contains('SIDOC-COREMTERCAM') ||
        empresa.contains('SIDOC-COOPERMA')) {
      return 'SIDOC';
    } else if (empresa.contains('TERNIUM-COREMTERCAM') ||
        empresa.contains('TERNIUM-COOPERMA')) {
      return 'TERNIUM';
    } else {
      return empresa;
    }
